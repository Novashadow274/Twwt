...
async def delete_and_log(context, chat_id, message_id, reason, user):
    ...
    try:
        ...
        pass
    log_text = f"🗑️ Deleted message from {user.mention_html()} in chat {chat_id}. Reason: {reason}"
...
async def handle_message(update, context):
    ...
    # Delete if banned word detected
    ...
    # Delete spammy emoji (>10 non-alphanumeric symbols)
